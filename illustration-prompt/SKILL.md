...
根据文档或上下文自动完成"哪里配图 → 什么风格 → 怎么写提示词"的全流程。

## Workflow

共 6 个阶段，按顺序执行。Step 3（风格锚点）和 Step 4（配图规划）产出需经用户确认后方可进入下一步。
...
- 配色方案:     warm amber + cyan + dark navy bg
- 渲染风格:   abstract topology, vector flat with subtle gradients
