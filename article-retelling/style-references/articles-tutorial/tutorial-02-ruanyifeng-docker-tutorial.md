...
作者：阮一峰
日期：2018年2月9日
来源：https://www.ruanyifeng.com/blog/2018/02/docker-tutorial.html
...
Docker CE 的安装请参考官方文档（Mac / Windows / Ubuntu / Debian / CentOS / Fedora / 其他 Linux 发行版）。
...
由于 Docker 官方提供的 image 文件，都放在`library`组里面，所以它是默认组，可以省略。因此，上面的命令可以写成下面这样。
